            ...
            <ul class="nav-menus">
                ...
                <li class="profile-nav onhover-dropdown p-0 mr-0">
                    <div class="media profile-media"><img class="b-r-10"
                            src="{{ asset('assets/images/dashboard/usuario.png') }}" alt="">
                        <div class="media-body"><span>Usuario</span>
                    ...
                    <ul class="profile-dropdown onhover-show-div">
                        ...
                        <li>
                            <form id="logout-form" action="{{ route('logout') }}" method="POST" class="form-logout">
                              @csrf
                                <a onclick="$('#logout-form').submit()">
                                    <i data-feather="log-in"></i><span>Cerrar Sesion</span>
                                </a>
                            </form>
                        </li>
                    </ul>
