...
return [
  ...
  "Configurations" => "Gestion de Configuraciones",
  "Projects" => "Gestion Proyectos",
  "Transactions" => "Gestion de Transacciones",
  "Kanban" => "Kanban",
  "ManagamentUser" => "Gestion de Usuarios",
  "Invoice" => "Invoice",
  ...
  "chart_income" => "Grafica de Ingresos",
  "Report_Service" => "Reporte de Servicios",
  "Report_Client" => "Reporte de Clientes",
  "Report_User" => "Reporte de Usuarios",
  "Report_Reservation" => "Reporte de Reservas",
];
